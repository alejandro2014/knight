...
OBJ_MAP=${OBJDIR_MAP}/${MAP01}.o ${OBJDIR_MAP}/${MAP02}.o ${OBJDIR_MAP}/${MAP03}.o
OBJ_WID=${OBJDIR_WID}/${WID01}.o ${OBJDIR_WID}/${WID02}.o
OBJ_REST=${OBJDIR}/${SRC01}.o ${OBJDIR}/${SRC02}.o ${OBJDIR}/${SRC03}.o
